...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By prince' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '918590565968@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  𝐏𝐑𝐈𝐍𝐂𝐄 𝐒𝐄𝐑 𝐁𝐎𝐓࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'prince-ser' : process.env.OWNER_SHIP,
    LIZA: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/FVvIqiO.jpeg' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴘʀɪɴᴄᴇ sᴇʀ࿐' : process.env.BOTV2_NAME,
