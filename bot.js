...
const {Message, StringSession, Image, Video} = require('./Prince/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('✅ Prince ser bot working!')
        );
...
*/
                        try {
                            ...
                            if (config.NOLOG == 'off') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ 𝐏𝐑𝐈𝐍𝐂𝐄 𝐒𝐄𝐑 𝐁𝐎𝐓࿐ ~______~*' +
